...
namespace Vankosoft\ThruwayBundle\Tests;
...
use Vankosoft\ThruwayBundle\Serialization\ArrayEncoder;
use Vankosoft\ThruwayBundle\Serialization\StdClassNormalizer;
use Vankosoft\ThruwayBundle\Tests\Fixtures\Person;
use Vankosoft\ThruwayBundle\WampKernel;
...
class WampKernelTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function get_resource_mapper()
    {
        ...
        $this->assertInstanceOf('Vankosoft\ThruwayBundle\ResourceMapper', $resourceMapper);
    }
}
